...
class VoxNet(nn.Module):
    ...
    def __init__(self, batch_size, output_size, input_size = (1, 110, 256, 256)):
        ...
        self.body = nn.Sequential(VoxNetLayer(in_channels=1, out_channels=16, kernel_size=5, stride=2),
                                  nn.Dropout3d(p=0.2),
                                  VoxNetLayer(in_channels=16, out_channels=16, kernel_size=3, stride=1),
                                  nn.MaxPool3d(2),
                                  nn.Dropout3d(p=0.3))
